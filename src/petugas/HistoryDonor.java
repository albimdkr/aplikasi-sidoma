 ...
 * @author albin
 */
public class HistoryDonor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DaftarMenu.setText("History Donor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryDonor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HistoryDonor().setVisible(true);
            }
        });
    }
