...
public class PrintUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        DaftarMenu.setText("Print Data User");
    ...
    private void BtnPrint21552011235MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnPrint21552011235MouseClicked
      try{
            String file = "/laporan/report_user.jasper";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
