 ...
 * @author albin
 */
public class AboutSekretaris extends javax.swing.JFrame {

    /**
     * Creates new form daftarMenu
     */
    public AboutSekretaris() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AboutSekretaris.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AboutSekretaris().setVisible(true);
            }
        });
    }
