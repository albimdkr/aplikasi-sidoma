 ...
 * @author albin
 */
public class stokDarah extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stokDarah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
